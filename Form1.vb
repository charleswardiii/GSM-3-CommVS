...
Public Class GSMTimed
    ...
    Dim gas1, gas2, gas3, pct1HB, pct1LB, pct2HB, pct2LB, pct3HB, pct3LB, tflowHB, tflowLB As Byte
    Dim command, mix_running As Byte
    Dim counter As Long
    Dim totalpct1, totalpct2, totalpct3, totalpct4
    Dim tflow, pct1, pct2, pct3 As Integer
    Dim Temp As String
    Dim dataFileName
    Dim hLogFile, MixNo As Integer
    Dim pct1a, pct1b, pct1c, pct2a, pct2b, pct2c, pct3a, pct3b, pct3c, pct4a, pct4b, pct4c
...
cleanup_and_exit:       ' close down sequencer operations
    ...
    Private Sub btnStore1_Click(sender As Object, e As EventArgs) Handles btnStore1.Click
        ...
        ' Note: Percent values are multiplied by 10 for sending to GSM; i.e., the upDn control's value is in tenths of percent.
        ...
        Dim bytes() As Byte = {1, gas1, pct1HB, pct1LB, gas2, pct2HB, pct2LB, gas3, pct3HB, pct3LB, tflowHB, tflowLB}
        MSComm1.PortName = comboPort.Text
        MSComm1.Open()                  ' Open the port.
    ...
    Private Sub btnStore2_Click(sender As Object, e As EventArgs) Handles btnStore2.Click
        ...
        ' send output as array of bytes
        Dim bytes() As Byte = {2, gas1, pct1HB, pct1LB, gas2, pct2HB, pct2LB, gas3, pct3HB, pct3LB, tflowHB, tflowLB}
        MSComm1.PortName = comboPort.Text
        MSComm1.Open()                  ' Open the port.
        MSComm1.Write(bytes, 0, bytes.Length)
        MSComm1.Close()                 ' Close the port.
    ...
    Private Sub btnStore3_Click(sender As Object, e As EventArgs) Handles btnStore3.Click
        ...
        ' send output as array of bytes
        Dim bytes() As Byte = {3, gas1, pct1HB, pct1LB, gas2, pct2HB, pct2LB, gas3, pct3HB, pct3LB, tflowHB, tflowLB}
        MSComm1.PortName = comboPort.Text
        MSComm1.Open()                  ' Open the port.
        MSComm1.Write(bytes, 0, bytes.Length)
        MSComm1.Close()
    ...
    Private Sub btnStore4_Click(sender As Object, e As EventArgs) Handles btnStore4.Click
        ...
        ' send output as array of bytes
        Dim bytes() As Byte = {4, gas1, pct1HB, pct1LB, gas2, pct2HB, pct2LB, gas3, pct3HB, pct3LB, tflowHB, tflowLB}
        MSComm1.PortName = comboPort.Text
        MSComm1.Open()                  ' Open the port.
        MSComm1.Write(bytes, 0, bytes.Length)
        MSComm1.Close()
    ...
    Private Sub LoadConfigurationToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LoadConfigurationToolStripMenuItem.Click
        ...
        If openFileDialog1.ShowDialog() = System.Windows.Forms.DialogResult.OK Then
            ...
            Debug.Print(maxflow1, maxflow2, maxflow3, FillGas)
